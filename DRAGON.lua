...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/ososs9/ELGAMDEN/main/File_Bot/commands.lua") 
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=t.me/DEV_MICKEY/9=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '00:00', url="t.me/DEV_MICKEY"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=t.me/DEV_MICKEY/9=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = ':T::O: :A::S::K:', url="https://t.me/DEV_MICKEY"}},
 {{text = 'بوت التواصل', url="t.me/TWASOL_MICKEYBOT"}},
 {{text = 'سورس ميكي', url="t.me/mickeybott"}},
} 
local msg_id = msg.id_/2097152/0.5 
...
os.execute('wget https://raw.githubusercontent.com/ososs9/ELGAMDEN/main/DRAGON.lua')
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'بًـوٌتٌ آلَتٌـوٌاصّـلَ  ☑ ➘', url="t.me/TWASOL_MICKEYBOT"}}, 
{{text = 'تواصل ميكي  ☑ ➘', url="t.me/DEV_MICKEY"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=t.me/mickeybott/5&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/mickeybott/3&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == '𖤍━┅┅┄⟞⟦꧁MICKEY ꧂⟧⟝┄┉┉━𖤍' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس ميكي ادخل وتابع الجديد](t.me/mickeybott)
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/mickeybott/3&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
19• •𖤍━┅┄⟞⟦꧁MICKEY ꧂⟧⟝┄┉━𖤍 {تعني قناه السورس https://t.me/mickeybott}
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/mickeybott/5&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
[[♢ | 𝐖𝐞𝐥𝐜𝐨𝐦𝐞 𝐓𝐨 𝐒𝐨𝐮𝐫𝐜𝐞 MICKEY](t.me/mickeybott)]

[[♢ | MICKEY 𝐓𝐡𝐞 𝐁𝐞𝐬𝐭 𝐒𝐨𝐮𝐫𝐜𝐞 𝐎𝐧 𝐓𝐞𝐥𝐞](t.me/mickeybott)]

[[♢ | 𝐅𝐨𝐥𝐥𝐨𝐰 𝐓𝐡𝐞 𝐁𝐮𝐭𝐭𝐨𝐧𝐬 𝐁𝐞𝐥𝐨𝐰](t.me/mickeybott)]
]]
...
local Text = [[
اوس اوس مبرمج سورس ميكي للتواصل معه اتبع الزر الاسفل 👇💕.
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/ososs9/ELGAMDEN/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/ososs9/ELGAMDEN/main/File_Bot/"..file)
if res == 200 then
